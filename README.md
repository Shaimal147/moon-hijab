...
5. Confirm the price policy for back-veil removal: it currently always requests a quote because no price is supplied. Faina is +50 where supported, but no exact total is claimed for removal. Cap and nose string are available for every niqab at +10 each. Qaaroora offers these two add-ons only; Malak and Shawl Niqab have no separate back veil to remove.
