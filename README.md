...
1. In `dist/assets/js/config.js`, set real `whatsappNumber` and `viberNumber`, in international format. Both are deliberately empty until confirmed. Missing contact channels are visibly disabled. Add address/hours only if desired.
